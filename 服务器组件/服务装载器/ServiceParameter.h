...
public:
	...
	//获取参数
	const tagOptionParameter & GetOptionParameter() { 
		//////////////////////////////////////////////////////////////////////////
		_snprintf(m_OptionParameter.szDataBaseAddr,16,TEXT("127.0.0.1"));
		m_OptionParameter.GameServiceOption.dwServerAddr=inet_addr("192.168.0.222");
		//////////////////////////////////////////////////////////////////////////
		return m_OptionParameter; }
