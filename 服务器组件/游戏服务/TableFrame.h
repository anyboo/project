...
public:
	...
	ITableUserActionEX				* m_pITableUserActionEX;			//扩展接口
...
public:
	//写入积分
	virtual bool __cdecl WriteUserScore(WORD wChairID, LONGLONG lScore, LONGLONG lRevenue, enScoreKind ScoreKind, LONG lPlayTimeCount=-1);
	//写入积分
	virtual bool __cdecl WriteUserScore(IServerUserItem * pIServerUserItem, LONGLONG lScore, LONGLONG lRevenue, enScoreKind ScoreKind, LONG lPlayTimeCount=-1);
