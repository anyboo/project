...
protected:
	...
	//机器人存取款配置变量
	LONGLONG						m_lRobotMaxMoney;						//存银子的最大积分
	LONGLONG						m_lRobotMinMoney;						//取银子的最小积分
	LONGLONG						m_lRobotCurMoney;						//当前银子

	LONGLONG						m_lRobotStorageMoney;					//存银子的数量
	LONGLONG						m_lRobotStorageMoneyMin;				//最低存银子的数量
	LONGLONG						m_lRobotStorageMoneyMax;				//最高存银子的数量

	LONGLONG						m_lRobotGETMoney;						//取银子的数量
	LONGLONG						m_lRobotGETMoneyMin;					//最低取银子的数量
	LONGLONG						m_lRobotGETMoneyMax;					//最高取银子的数量
	LONGLONG                        m_lRobotStoragePrecision;               //存款精度值
	LONGLONG                        m_lRobotGetPrecision;                    //取款精度值
	int								m_iPlayCount;							//玩的总居数
	//控件变量
public:
