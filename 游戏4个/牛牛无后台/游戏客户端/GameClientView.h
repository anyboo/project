...
// 	CPngButton						m_btBegin;							//开始
// 	CPngButton						m_btCall;							//叫庄
 	CPngButton						m_btCalling;							//叫庄中

	CPngImage						m_pngWaitBet;						//等待闲家
	CPngImage						m_pngWaitCall;						//等待叫庄
	CPngImage						m_pngBanker;						//庄标志
	CPngImage						m_pngNiuNum;						//牛几
	//控件变量
public:
...
public:
	...
	//逗号数值
	LPCTSTR NumToString(LONGLONG lLeaveScore);
	//绘画时间
