    ...
    case IDI_NORMAL_ADD_FISH_START:
        {
            ...
            {
				m_dwProbability = GAME_PROBABILITY;
				if (m_pGameServiceOption->lCellScore>=0) m_dwProbability = GAME_PROBABILITY*0.9;
				if (m_pGameServiceOption->lCellScore>=100) m_dwProbability = GAME_PROBABILITY*0.75;
				if (m_pGameServiceOption->lCellScore>=1000) m_dwProbability = GAME_PROBABILITY*0.58;
				if (m_pGameServiceOption->lCellScore>=5000) m_dwProbability = GAME_PROBABILITY*0.52;
				if (m_pGameServiceOption->lCellScore>=10000) m_dwProbability = GAME_PROBABILITY*0.45;
