...
CGameServiceManager::CGameServiceManager(void)
{
	...
	lstrcpyn(m_GameServiceAttrib.szDescription,TEXT("两张游戏服务组件"),CountArray(m_GameServiceAttrib.szDescription));
	lstrcpyn(m_GameServiceAttrib.szClientModuleName,TEXT("RedNineBattle.EXE"),CountArray(m_GameServiceAttrib.szClientModuleName));
	lstrcpyn(m_GameServiceAttrib.szServerModuleName,TEXT("RedNineBattleServer.DLL"),CountArray(m_GameServiceAttrib.szServerModuleName));
...
VOID * __cdecl CGameServiceManager::CreateAndroidUserItemSink(REFGUID Guid, DWORD dwQueryVer)
{
	try
	{
		...
		{
			m_AndroidServiceHelper.SetModuleCreateInfo(TEXT("RedNineBattleAndroid.dll"),TEXT("CreateAndroidService"));
