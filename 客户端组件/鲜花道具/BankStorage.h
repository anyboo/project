...
protected:
	...
	CSkinButton                     m_btPage[5];

protected:
	CPageDlg                        * m_pPageDlg[5];
	UINT                            m_nSelPage;
	CRect                           m_rcPage;
	DWORD							m_dwOption;
...
public:
	...
	//设置组件
	void SetSendInfo(IClientKernel *pClientKernel,ITCPSocket *pClientSocket,tagUserData *pMeUserDatas, LPCTSTR PassWord);
	//发送信息
