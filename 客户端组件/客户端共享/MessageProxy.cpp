...
CMessageProxy::CMessageProxy(void)
{
	...
	m_MessageOption.crSystemHead=RGB(191,163,19);
	m_MessageOption.crSystemString=RGB(191,163,19);
...
// 
// 	//		//装载图片			
// 		_snprintf(szFileName,sizeof(szFileName),TEXT("%s\\Face\\555.gif"),m_szPath, -1);
...
// 
// 	//		//装载图片			
// 		_snprintf(szFileName,sizeof(szFileName),TEXT("%s\\Face\\666.gif"),m_szPath, -1);
// 			m_pSkinRichEdit->InsertImage(szFileName);
