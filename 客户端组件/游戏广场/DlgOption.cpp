...
HBRUSH CDlgOptionItem::OnCtlColor(CDC * pDC, CWnd * pWnd, UINT nCtlColor)
{
	...
	{
		HBRUSH hr = CreateSolidBrush(g_GlobalOption.m_crOwnColor);
	...
	{
		HBRUSH hr = CreateSolidBrush(g_GlobalOption.m_crFriendColor);
...
//////////////////////////////////////////////////////////////////////////
void CDlgOptionSystem::DoDataExchange(CDataExchange* pDX)
{
...
void CDlgOptionSystem:: OnBnClickedEdit()
	{
	//设置颜色
		CColorDialog ColorDialog(g_GlobalOption.m_crOwnColor,CC_FULLOPEN);
		if (ColorDialog.DoModal()==IDOK) g_GlobalOption.m_crOwnColor = ColorDialog.GetColor();
...
void CDlgOptionSystem:: OnBnClickedEdit1()
	{
		//设置颜色
		CColorDialog ColorDialog(g_GlobalOption.m_crFriendColor,CC_FULLOPEN);
		if (ColorDialog.DoModal()==IDOK) g_GlobalOption.m_crFriendColor = ColorDialog.GetColor();
