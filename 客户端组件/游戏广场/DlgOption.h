...
public:
	...
	virtual void OnBnClickedEdit()=NULL;
	virtual void OnBnClickedEdit1()=NULL;
	//功能函数
public:
	//创建函数
...
public:
	...
	virtual void OnBnClickedEdit();

	virtual void OnBnClickedEdit1();
};
...
public:
	...
	//获取标题
	virtual LPCTSTR GetButtonText();
	virtual void OnBnClickedEdit() {return;}

	virtual void OnBnClickedEdit1(){return;}
};
