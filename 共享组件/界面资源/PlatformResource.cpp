...
bool __cdecl CPlatformResource::GetServerViewImage(tagServerViewImage * ServerViewImage)
{
	...
	ServerViewImage->uBtRoomSet=DEF_IDB_BT_ROOM_SET;
	ServerViewImage->uBtBindPc = IDB_LOCKROOM;
...
bool __cdecl CPlatformResource::GetPlatformFrameImage(tagPlatformFrameImage * PlatformFrameImage)
{
	...
	PlatformFrameImage->uBtFrameLock=IDB_LOCKROOM;
	...
	PlatformFrameImage->uFrameNavigation[5]=DEF_IDB_FRAME_BT_NAVIGATION_6;
	PlatformFrameImage->uFrameNavigation[6]=DEF_IDB_FRAME_BT_NAVIGATION_7;
...
bool __cdecl CPlatformResource::GetControlViewImage(tagControlViewImage * ControlViewImage)
{
	...
	ControlViewImage->uUserInfoM=DEF_IDB_USER_INFO_M;
	ControlViewImage->uServerIfnoB=DEF_IDB_SERVER_INFO_B;
	ControlViewImage->uServerIfnoM=DEF_IDB_SERVER_INFO_M;
	ControlViewImage->uServerIfnoT=DEF_IDB_SERVER_INFO_T;
