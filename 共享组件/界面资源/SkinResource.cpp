...
bool __cdecl CSkinResource::GetResourceInfo(tagSkinEditResource & SkinEditResource)
{
	...
	SkinEditResource.m_ImageBottom.hResourceDLL=hInstance;
	SkinEditResource.m_ImageBottom.uResourceID=DEF_IDB_SKIN_WND;
...
bool __cdecl CSkinResource::GetResourceInfo(tagSkinDialogResource & SkinDialogResource)
{
	...
	//边框信息
	SkinDialogResource.crTitleText=RGB(255,255,255);
	SkinDialogResource.crControlText=RGB(0,0,0);
	SkinDialogResource.crBackGround=RGB(218,222,223);
	...
	SkinDialogResource.Left.hResourceDLL=hInstance;
	SkinDialogResource.Right.hResourceDLL=hInstance;
	SkinDialogResource.BottomM.hResourceDLL=hInstance;
	SkinDialogResource.BottomL.hResourceDLL=hInstance;
	SkinDialogResource.BottomR.hResourceDLL=hInstance;
	SkinDialogResource.Left.uResourceID=DEF_IDB_SKIN_WND_LEFT;
	SkinDialogResource.Right.uResourceID=DEF_IDB_SKIN_WND_RIGHT;
	SkinDialogResource.BottomM.uResourceID=DEF_IDB_SKIN_WND_BOTTOMM;
	SkinDialogResource.BottomL.uResourceID=DEF_IDB_SKIN_WND_BOTTOML;
	SkinDialogResource.BottomR.uResourceID=DEF_IDB_SKIN_WND_BOTTOMR;
	return true;
}
...
bool __cdecl CSkinResource::GetResourceInfo(tagSkinButtonResource & SkinButtonResource)
{
	...
	SkinButtonResource.LoadInfoCheck.hResourceDLL=hInstance;
	SkinButtonResource.LoadInfoCheck.strFileName=TEXT("DEF_IDB_SKIN_CHECK_BOX");

	SkinButtonResource.LoadInfoPng.hResourceDLL=hInstance;
	//SkinButtonResource.LoadInfoCheck.uResourceID=DEF_IDB_SKIN_BUTTON_CHECK;
	SkinButtonResource.LoadInfoPng.strFileName = TEXT("DEF_SKIN_PNGBUTTON");
...
bool __cdecl CSkinResource::GetResourceInfo(tagSkinListCtrlResource & SkinListCtrlResource)
{
	...
	SkinListCtrlResource.dwHeadHight = 25;

	//资源信息
	SkinListCtrlResource.LoadInfoImageBackLeft.hResourceDLL=hInstance;
	SkinListCtrlResource.LoadInfoImageBackLeft.uResourceID=DEF_IDB_SKIN_HEAD_TITLE_LEFT;
	SkinListCtrlResource.LoadInfoImageBackRight.hResourceDLL=hInstance;
	SkinListCtrlResource.LoadInfoImageBackRight.uResourceID=DEF_IDB_SKIN_HEAD_TITLE_RIGHT;
	SkinListCtrlResource.LoadInfoImageBackMid.hResourceDLL=hInstance;
	SkinListCtrlResource.LoadInfoImageBackMid.uResourceID=DEF_IDB_SKIN_HEAD_TITLE_MID;
	return true;
}
