...
struct tagSkinButtonResource
{
	...
	tagImageLoadInfo				LoadInfoCheck;						//多选按钮
	tagImageLoadInfo				LoadInfoPng;						//png按钮
};
...
struct tagSkinDialogResource
{
	...
	tagImageLoadInfo                BottomM;
    tagImageLoadInfo                BottomL;
	tagImageLoadInfo                BottomR;
};
...
struct tagSkinListCtrlResource
{
	...
	DWORD							dwHeadHight;						//表头高度

	//资源信息
	tagImageLoadInfo				LoadInfoImageBackLeft;					//加载信息
	tagImageLoadInfo				LoadInfoImageBackMid;					//加载信息
	tagImageLoadInfo				LoadInfoImageBackRight;					//加载信息
};
