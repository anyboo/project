...
//对话框类
class SKIN_CONTROL_CLASS CSkinDialog1 : public CDialog, public CSkinWndObject
{
	//函数定义
public:
	//构造函数
	CSkinDialog1(UINT nIDTemplate1, CWnd * pParentWnd1=NULL);
	//析构函数
	virtual ~CSkinDialog1();
...
//对话框类
class SKIN_CONTROL_CLASS CSkinDialogEx1 : public CSkinDialog1
{
	//函数定义
public:
	//构造函数
	CSkinDialogEx1(UINT nIDTemplate1, CWnd * pParentWnd1=NULL);
	//析构函数
	virtual ~CSkinDialogEx1();
...
protected:
	...
	DECLARE_MESSAGE_MAP()
	DECLARE_DYNAMIC(CSkinDialogEx1)
};
//////////////////////////////////////////////////////////////////////////
