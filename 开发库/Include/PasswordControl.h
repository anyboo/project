...
//密码键盘
class CLIENT_SHARE_CLASS CPasswordKeyboard : public CDialog
{
	//配置变量
protected:
...
//密码编辑
class CLIENT_SHARE_CLASS CPasswordControl : public CWnd
{
	//友元定义
...
protected:
	...
	TCHAR							m_szPassword[32];			//用户密码

	//控件变量
protected:
	CSkinEditEx						m_edPassword;						//密码控件
	//CSkinEditEx						m_edPassword1;						//密码控件
...
public:
	...
	//获取密码
	LPCTSTR GetUserPassword(TCHAR szPassword[32]);
